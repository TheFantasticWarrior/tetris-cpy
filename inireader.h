...
inline int INIReader::GetInteger(const std::string& section, const std::string& name, int default_value) const
{
    ...
    return end>value ? n : end[0] ? int(end[0]) : default_value;
}
